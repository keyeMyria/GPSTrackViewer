...
import de.ronnyfriedland.mytrackvisualizer.R;
import de.ronnyfriedland.mytrackvisualizer.R.id;
import de.ronnyfriedland.mytrackvisualizer.R.layout;
import de.ronnyfriedland.mytrackvisualizer.R.menu;
import de.ronnyfriedland.mytrackvisualizer.R.string;
...
public class GpsTrackViewerActivity extends MapActivity {
	...
	private void loadContent() {
		...
		loadTrack(
				prefs.getStringSet(PreferenceKeys.TRACK.getKey(), Collections.EMPTY_SET),
	...
	private void loadTrack(final Set<String> gpxFileNames, final Integer color) {
		...
		textView.setText(String.format(getResources().getString(R.string.msg_track),
				Arrays.toString(gpxFileNames.toArray(new String[gpxFileNames.size()])), length / 1000));
	}
}
